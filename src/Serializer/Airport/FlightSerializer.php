...
class FlightSerializer implements ContextAwareNormalizerInterface
{
    ...
    public function normalize($object, string $format = null, array $context = [])
    {
        return [
            'id' => $object->getId(),
            'departure_airport' => $object->getDepartureAirport(),
            'arrival_airport' => $object->getArrivalAirport(),
            'departure_datetime' => $object->getDepartureDatetime()->format('Y-m-d'),
            'arrival_departure' => $object->getArrivalDeparture(),
            'main_pilot' => $object->getMainPilot(),
        ];
    }
}